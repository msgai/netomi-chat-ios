...
#ifndef NETOMI_SWIFT_H
#define NETOMI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Netomi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Netomi15AnimatedControl")
...
SWIFT_CLASS("_TtC6Netomi14AnimatedButton")
...
SWIFT_CLASS("_TtC6Netomi14AnimatedSwitch")
...
SWIFT_CLASS("_TtC6Netomi16AnimationSubview")
...
SWIFT_CLASS("_TtC6Netomi19CompatibleAnimation")
...
SWIFT_CLASS("_TtC6Netomi26CompatibleAnimationKeypath")
...
SWIFT_CLASS("_TtC6Netomi23CompatibleAnimationView")
...
SWIFT_CLASS("_TtC6Netomi32CompatibleDictionaryTextProvider")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC6Netomi20LottieAnimationLayer")
...
SWIFT_CLASS("_TtC6Netomi23LottieAnimationViewBase")
...
/// </ul>
IB_DESIGNABLE
SWIFT_CLASS("_TtC6Netomi19LottieAnimationView")
...
SWIFT_CLASS("_TtC6Netomi10NetomiChat")
@interface NetomiChat : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
