Pod::Spec.new do |s|
  ...
  s.swift_version = '5.9'
  s.source       = {
    :http => "https://netomi-sdk-public.s3.amazonaws.com/sdk/ios/releases/1.28.0/NetomiChatSDK.zip"
  }
  ...
  s.subspec 'Core' do |core|
    ...
    core.dependency 'DatadogCore', '~> 3.12.0'
    core.dependency 'DatadogLogs', '~> 3.12.0'
