Pod::Spec.new do |s|
  ...
  s.swift_version = '5.9'
  s.source       = {
    :http => "https://netomi-sdk-public.s3.amazonaws.com/sdk/ios/releases/1.23.0/Netomi.xcframework.zip"
  }
  ...
  s.dependency 'DatadogCore', '~> 3.10'
  s.dependency 'DatadogLogs', '~> 3.10'
end
