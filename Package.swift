...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "NetomiCore",
            url: "https://netomi-sdk-public.s3.amazonaws.com/sdk/ios/releases/1.27.0/NetomiCore.xcframework.zip",
            checksum: "5dcd5f033fd1594979f8f690480f20163059fe79823042eb4ad4052503f9aef7"
        ),
        .binaryTarget(
