...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "NetomiCore",
            url: "https://netomi-sdk-public.s3.amazonaws.com/sdk/ios/releases/1.32.3/NetomiCore.xcframework.zip",
            checksum: "https://netomi-sdk-public.s3.amazonaws.com/sdk/ios/releases/1.32.3/NetomiCore.xcframework.zip"
        ),
        .target(
            name: "Netomi",
            dependencies: [
