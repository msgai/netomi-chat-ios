...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "NetomiCore",
            url: "https://netomi-sdk-public.s3.amazonaws.com/sdk/ios/releases/1.24.4/NetomiCore.xcframework.zip",
            checksum: "ba6ebf9aeb0dbefc3732790dd2877ae5df1018f3d34e9f1bf64a15d9efde36d2"
        ),
        .binaryTarget(
